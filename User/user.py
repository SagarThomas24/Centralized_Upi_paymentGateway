...
def register_user(username, password, ifsc_code, pin, mobile_number):
    ...
    sql = """INSERT INTO users (uid, username, ifsc_code, password_hash, pin_hash, mobile_number, mmid) 
             VALUES (%s, %s, %s, %s, %s, %s, %s)"""
    values = (uid, username, ifsc_code, password_hash, pin_hash, mobile_number, mmid)
...
register_user("Alice", "securePass123", "HDFC0001234", "1234", "9876543210")
